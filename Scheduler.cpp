    ...
    do
    {
        ...
        if (person == "D" || person == "d")
        {
            if (type == "I" || type == "i")
            {
                ...
                // List out the possible Doctor Specialties for the user
                cout << "==================================" << endl;
                cout << "||" "\t" "PED" << "\t" << "FAM" << "\t" << "INT"<< "\t" << "||" << endl;
                cout << "||" "\t" "CAR" << "\t" << "SUR" << "\t" << "OBS"<< "\t" << "||" << endl;
                cout << "||" "\t" "PSY" << "\t" << "NEU" << "\t" << "ORT"<< "\t" << "||" << endl;
                cout << "||" "\t" "DET" << "\t" << "OPT" << "\t" << "ENT"<< "\t" << "||" << endl;
                cout << "==================================" << endl;
                cout << "Enter one of the above valid specialty codes: ";
                cin >> code;
        ...
        else if (person == "P" || person == "p")
        {
            if (type == "I" || type == "i")
            {
                ...
                // List out the possible Doctor Specialties for the user
                //====================================================================
                // I added this after the test plan screen shots, I did not want to
                // redo the screen shots in the test plan
                //====================================================================
                cout << "==================================" << endl;
                cout << "||" "\t" "PED" << "\t" << "FAM" << "\t" << "INT"<< "\t" << "||" << endl;
                cout << "||" "\t" "CAR" << "\t" << "SUR" << "\t" << "OBS"<< "\t" << "||" << endl;
